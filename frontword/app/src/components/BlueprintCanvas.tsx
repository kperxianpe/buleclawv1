...
import { Brain, Cpu, Settings, X } from 'lucide-react';
  ...
  return (
    <div className={backgroundClass} style={getBackgroundClass()}>
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        {/* 左侧 - 思考蓝图 */}
        <div className="flex flex-col bg-blue-900/20" style={{ flex: `0 0 ${leftRatio}%` }}>
          {/* Header */}
        ...
        {/* 中间分隔栏 - 图标按钮 */}
        <div className="w-[60px] flex flex-col items-center py-4 bg-slate-800/80 border-x border-slate-700/50 z-10 shadow-xl">
          {/* 设置图标按钮 */}
          <button
        ...
        <div className="flex-1 flex flex-col bg-blue-900/20">
          ...
          >
            <div className="w-full h-full bg-gradient-to-br from-pink-400 via-pink-500 to-yellow-400 flex items-center justify-center">
              <span className="text-white/60 text-lg font-medium">视觉区域 (Visual Area)</span>
            </div>
          </div>
        </div>
      </div>
